 ...
 * `CONCURRENCY_MAX = 10`. This plugin reproduces the friendly default
 * that the manifest-plugins project considers appropriate for typical
 * agent workloads.
 ...
 * write a new plugin and put it earlier in the `plugins` array. The
 * host's first-non-null-wins semantics makes plugin ordering
 * meaningful.
 *
